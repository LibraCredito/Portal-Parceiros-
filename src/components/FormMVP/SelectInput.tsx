...
// Quando se trata de tomadores, somente Pessoa física será cadastrado, agora garantidores poderá ser PF ou PJ;
...
// Com Pessoa Juridica;
export const SelectInputPFPJ: React.FC<SelectInputProps> = ({
  options,
  value,
  onChange,
  label,
